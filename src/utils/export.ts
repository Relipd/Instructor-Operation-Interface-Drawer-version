...
// xlsx 体积较大（~400kB），改为动态 import：仅在用户点击「导出Excel」时加载，不进主 chunk
export async function exportToExcel(records: ExceptionRecord[], filename?: string) {
